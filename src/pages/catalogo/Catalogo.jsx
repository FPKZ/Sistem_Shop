...
export default function Catalogo(){
    const { produtos, carrinho, handleChangeQuantity, totalItens, pedir, carrinhoAberto, setCarrinhoAberto } = useCatalogo()
    ...
    return(
        <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", backgroundColor: "#f8f9fa" }}>
            ...
            {
                carrinhoAberto ? (
                    <Carrinho produtos={produtos} carrinho={carrinho} handleChangeQuantity={handleChangeQuantity} totalItens={totalItens} pedir={pedir} />
                ) : (
