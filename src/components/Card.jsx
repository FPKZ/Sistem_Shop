export function Card(props) {
    return (
        <div className="col col-sm-3 col-md-2 col-lg-auto">
          <div className="card text-center h-100 shadow-sm" onClick={() => {props.location?.(); props.setTela?.()}} style={{cursor: 'pointer'}}>
